...
export function seedStarter(db: Database.Database) {
  ...
  db.transaction(() => {
    ...
    const publicReports: Array<[string, string, string, string, string, Array<[string, number]>]> = [
      ["world-population", "World population (millions)", "Rounded historical estimates, 1950 to 2024, in millions.", "UN World Population Prospects 2024", "https://population.un.org/wpp/", [["1950", 2500], ["2000", 6100], ["2024", 8200]]],
      ["olympic-women", "Women at the Paris Olympics", "Women athletes in 1900, 1924, and 2024; counts, not percentages.", "Paris 2024 official report", "https://library.olympics.com/digitalCollection/DigitalCollectionAttachmentDownloadHandler.ashx?documentId=3702240&parentDocumentId=3598869&skipCopyright=true&skipWatermark=true", [["1900", 22], ["1924", 135], ["2024", 5300]]],
    ...
    publicReports.forEach(([slug, title, description, source, sourceUrl, values], i) => {
      report.run(slug, "Around the world", title, description, "bars", null, source, sourceUrl, i, now);
